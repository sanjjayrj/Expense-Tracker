...
urlpatterns = [
    ...
    path('addexpense_submission/',views.addexpense_submission,name='addexpense_submission'),
    path('charts/',views.charts,name='charts'),
    path('tables/',views.tables,name='tables'),
    path('expense_edit/<int:id>',views.expense_edit,name='expense_edit'),
    path('<int:id>/addexpense_update/', views.addexpense_update, name="addexpense_update") ,
